...
<head>
	...
	<link rel="stylesheet" href="http://themes.semicolonweb.com/html/canvas/css/bootstrap.css" type="text/css" />
	<link rel="stylesheet" href="http://themes.semicolonweb.com/html/canvas/style.css" type="text/css" />
	<link rel="stylesheet" href="http://themes.semicolonweb.com/html/canvas/css/dark.css" type="text/css" />
	<link rel="stylesheet" href="http://themes.semicolonweb.com/html/canvas/css/font-icons.css" type="text/css" />
	<link rel="stylesheet" href="http://themes.semicolonweb.com/html/canvas/css/animate.css" type="text/css" />
	<link rel="stylesheet" href="http://themes.semicolonweb.com/html/canvas/css/magnific-popup.css" type="text/css" />

	<link rel="stylesheet" href="http://themes.semicolonweb.com/html/canvas/css/responsive.css" type="text/css" />
	<meta name="viewport" content="width=device-width, initial-scale=1" />

	<!-- SLIDER REVOLUTION 5.x CSS SETTINGS -->
	<link rel="stylesheet" type="text/css" href="http://themes.semicolonweb.com/html/canvas/include/rs-plugin/css/settings.css" media="screen" />
	<link rel="stylesheet" type="text/css" href="http://themes.semicolonweb.com/html/canvas/include/rs-plugin/css/layers.css">
	<link rel="stylesheet" type="text/css" href="http://themes.semicolonweb.com/html/canvas/include/rs-plugin/css/navigation.css">
...
<body class="stretched">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					<nav id="primary-menu">
						...
						<ul>
							<li><a href="{{ url('/') }}"><div>首頁</div></a>
							</li>
							<li class="current"><a href="{{ url('/shop') }}"><div>商店</div></a></li>
						</ul>
									...
									@foreach ($items as $item)
										<div class="product clearfix">
											<div class="product-image">
												<a href="{{ url('/shop/addcart/'.$item->id) }}"><img src="{{ Voyager::image($item->pic) }}" alt="{{ $item->title }}"></a>
												@if ($item->badge != null)
													<div class="sale-flash">{{ $item->badge }}</div>
												@endif
												
												<div class="product-overlay">
													<a href="{{ url('/shop/addcart/'.$item->id) }}" class="add-to-cart"><i class="icon-shopping-cart"></i><span> 下單</span></a>
												</div>
											</div>
											<div class="product-desc">
												<div class="product-title"><h3><a href="{{ url('/shop/addcart/'.$item->id) }}">{{ $item->title }}</a></h3></div>
		...
		<footer id="footer" class="dark">
			...
			<div id="copyrights">
				...
				<div class="container clearfix">
					...
					<div class="col_half">
						Copyrights &copy; 2019 All Rights Reserved by Goblin Lab Studio.<br>
						<div class="copyright-links"><a href="#">Terms of Use</a> / <a href="#">Privacy Policy</a></div>
					</div>

					<div class="col_half col_last tright">

						<i class="icon-envelope2"></i> info@goblinlab.org <span class="middot">&middot;</span> <i class="icon-headphones"></i> +886939287209 <span class="middot">&middot;</span> <i class="icon-skype2"></i> javck
					</div>
	...
	<script src="http://themes.semicolonweb.com/html/canvas/js/plugins.js"></script>
	...
	<script src="http://themes.semicolonweb.com/html/canvas/include/rs-plugin/js/jquery.themepunch.tools.min.js"></script>
	<script src="http://themes.semicolonweb.com/html/canvas/include/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>

	<script src="http://themes.semicolonweb.com/html/canvas/include/rs-plugin/js/extensions/revolution.extension.video.min.js"></script>
	<script src="http://themes.semicolonweb.com/html/canvas/include/rs-plugin/js/extensions/revolution.extension.slideanims.min.js"></script>
	<script src="http://themes.semicolonweb.com/html/canvas/include/rs-plugin/js/extensions/revolution.extension.actions.min.js"></script>
	<script src="http://themes.semicolonweb.com/html/canvas/include/rs-plugin/js/extensions/revolution.extension.layeranimation.min.js"></script>
	<script src="http://themes.semicolonweb.com/html/canvas/include/rs-plugin/js/extensions/revolution.extension.kenburn.min.js"></script>
	<script src="http://themes.semicolonweb.com/html/canvas/include/rs-plugin/js/extensions/revolution.extension.navigation.min.js"></script>
	<script src="http://themes.semicolonweb.com/html/canvas/include/rs-plugin/js/extensions/revolution.extension.migration.min.js"></script>
	<script src="http://themes.semicolonweb.com/html/canvas/include/rs-plugin/js/extensions/revolution.extension.parallax.min.js"></script>
